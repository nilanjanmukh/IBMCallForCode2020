...
const DonationsStackOptions = ({ navigation }) => {
  return ({
    headerRight: () => (
      <Button
        onPress={() => navigation.navigate('Add Workers')}
        title='Add '
      />
    )
  });
...
const DonateStackLayout = () => (
  <Stack.Navigator>
  <Stack.Screen name='Worker' component={MyResources} options={DonationsStackOptions} />
    <Stack.Screen name='Add Workers' component={AddResource} />
    <Stack.Screen name='Edit Workers' component={EditResource} />
  </Stack.Navigator>
);

const SearchStackLayout = () => (
  <Stack.Navigator>
    <Stack.Screen name='Search Workers' component={SearchResources} options={ResourcesStackOptions} />
